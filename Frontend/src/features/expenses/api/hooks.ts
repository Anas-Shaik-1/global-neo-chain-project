...
// User-submittable categories (what the FE forms expose for selection).
// SALARY is system-generated by payroll and isn't selectable in any UI.
...
// Full set of categories that can come back from the API, including the
// system-generated SALARY entries the payroll service mirrors.
